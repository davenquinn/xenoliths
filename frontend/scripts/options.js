	...
	options = {
		samples: {
			...
			"CK-5": {
				...
				"layers": {
					"sem": [0.0, -9854.0],
					"scan": [-956,-11197]//[-485*2,-11882]//0.0, -12571.0, 12402.0, 0.0
				},
				"color": "#3A9B88"
			},
			"CK-6": {
				...
				"layers": {
					"sem": [0.0, -8338.0],
					"scan": [-2*816-6,-11632+526+516]// 0.0, -11632.0, 11528.0, 0.0
				},
				"color": "#FF2C00"
			},
			"CK-7": {
				...
				"layers": {
					"sem": [0.0, -9096.0],
					"scan": [-782-194,-(9096+482)-566] //0.0, -11642.0, 11529.0, 0.0
				},
				"color": "#8BD750"
			},
			"CKD1": {
				"bounds": [0.0, -9854.0, 13776.0, 0.0],
				"layers": {
					"sem": [0.0, -9854.0],
					"scan": [0.0, -9854.0] //0.0, -11642.0, 11529.0, 0.0
				},
				"color": "#888888"
			},
			"CKD2": {
				"bounds": [0.0, -5306.0, 11904.0, 0.0],
				"layers": {
					"sem": [0.0, -5306.0],
					"scan": [0.0, -5306.0] //0.0, -11642.0, 11529.0, 0.0
				},
				"color": "#444444"
			}
		},
