...
upon closer analysis require a combination of slab
...
which most logically is located at the underlying Moho. In this context, the
...
plate batholithic exposures. In @fig:reconstruction, the current
...
Franciscan [@Hall2013], but have been
...
resolved beneath the Dish Hill xenolith location in the Mojave region [@Luffi2009].
These scenarios have been posed by a number of workers as detailed below.

## The Neogene slab window {#sec:slab_window}

@fig:reconstruction shows the hypothetical surface projections of the
Pacific-Farallon slab window
and partially subducted Monterey plate at ca. 19 Ma [@Wilson2005].
The slab window formed by the subduction of the trailing edge
...
Neogene, ~50-100 km northeast of the northeastern boundary transform edge of the
...
requires that its downdip extension was translated effectively horizontally
along, or sub-parallel to the former subduction interface beneath the Coast Ranges.
...
western Transverse Ranges bedrock panels [@Bohannon1995; @Wilson2005; @fig:context].
...
eastern residual roof of continental mantle lithosphere. In that the crustal
...
This is shown to have occurred in conjunction with shallow flat subduction
...
@Kidder2006;@Chapman2010;@Chapman2012;@Chapman2016a.
...
zone. Suction forces of the retreating slab drove
...
The lack of high-pressure mafic schist samples in both the Crystal Knob and Dish
...
underplated as the thickened mafic lower crust of the
region, which has been seismically imaged  [@Trehu1991; @Brocher1999].
...
time, and below we layer the complexity of late Cenozoic tectonics onto
our analysis.
...
[@Erkan2008] have only investigated the resulting emplacement of
...
We next model the thermal evolution of the coastal
