...
which we summarize in @sec:slab_window‌-‌-@sec:farallon_nappe.
...
extends eastward of the San Andreas fault. This "dangling" horizontally
translated slab descends eastwards beneath the
Central Valley, corresponding to the "Isabella" high-wave speed seismic
anomaly [@tenBrink1999; @Pikser2012; @Wang2013; @fig:context].
...
the Late Cretaceous convergent margin [after @Saleeby2003 and @Luffi2009].
...
time, and below we layer on the complexity of late Cenozoic tectonics in
our analysis.
