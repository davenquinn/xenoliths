...
are shown in @tbl:trace_elements.
...
peridotites [@fig:cpx_literature_comparison]. The high-temperature
...
re-enrichment paths of the Crystal Knob samples.
...
fluids to this value is shown in @fig:ree_trends and corresponds
...
in @tbl:depletion_degrees and are superficially similar to
the trends visible in modal abundance [@fig:modes] and trace element
