...
<p class="response r1">Updated wording substantially and reordered to clarify importance of mantle xenoliths constraints constraint.</p>
<p class="response r1">Added new clarifications of time-corrected isotope values.</p>

<p class='comment r1'> In lines 5-6, xenolith studies are said to link crustal structure, but
I found this confusing because they are supposed to be mantle xenoliths.
Clarify.
<span>Reversed order of a few sentences to reword</span>
</p>
...
<span> Added Pacific-Farallon ridge provisionally, but it gets confusing
...
<span class="response"> The California coast is a key distinguisher, and saying
...
cite a reference.
<span class='response'>Changed in one instance for clarity, but kept
...
<span class='response'>Used e.g. and listed earlier Glazner ref</span>
</p>


<p class="comment r2"> Line 22: I don't think the quotes around Salinian
terrane or Salinia are necessary </p>


Line 26: Added Barbeau, 2005 reference

<p class="comment r2"> Line 36 (and elsehere): pay attention to the order of
the references
...
<span class="response"> We understand the concern but have left things mostly
unchanged. “Dunites” would be properly set against “polyphase peridotites” or
“lherzolites and harzburgites”. We think that using “peridotite” as a shorthand
for “polyphase peridotites” is appropriate and understandable phrasing. </span>
</p>
...
or any kind of mafic xemolith? </p>


<p class="comment r2">
337: where does the reader find these averages? (table 7? Figs 10, 11?) </p>

<p class="comment r3"> 340 add "in olivine" after "compatible" </p>
...
pMELTS. OR explain the utility of the generic model first. </p>
